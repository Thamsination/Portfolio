    ...
    <div className="bg-white">
      ...
      <section className="bg-white py-12 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900" style={{ marginBottom: '2rem' }}>Featured Projects</h2>
          ...
          >
            {companies.map((company) => (
              <a
                ...
                className="group flex items-center justify-center opacity-50 hover:opacity-100 transition-all hover:scale-105"
                title={company.name}
              >
                <Image
                  src={company.logo}
