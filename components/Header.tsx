    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link 
            href="/" 
            className="font-heading text-2xl font-bold text-gray-900 hover:text-gray-700 transition-colors"
          >
            Christian Thams
          </Link>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-4 py-2 space-y-1">
              ...
              {/* Mobile: LinkedIn and CV */}
              <div className="pt-2 mt-2 border-t border-gray-200 flex items-center gap-4 px-3">
                <a
                  href="https://www.linkedin.com/in/christian-thams-15a302a4/"
                  target="_blank"
                  rel="noopener noreferrer"
